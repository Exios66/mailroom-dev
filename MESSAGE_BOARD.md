...
|---|---|---|---|
| KANBAN-019 | v0.18.0 prep (2026-08-15) | slides commit (KANBAN-019) | Four prompt-iteration post-mortem decks shipped in `docs/slides/` (08-problems-sorter, 09-fixes-sorter, 10-problems-contracts-specialist, 11-fixes-contracts-specialist) — same problems→fixes framing per agent, data-backed from the changelog + A/B records; README index updated; docs-only, no changelog entry |
